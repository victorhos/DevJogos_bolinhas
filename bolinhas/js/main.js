window.onload = function() {
	...
	function create() {
		...
		line1 = new Phaser.Line(bolinha1.x, bolinha1.y, 
								bolinha2.x, bolinha2.y);
		line2 = new Phaser.Line(bolinha2.x, bolinha2.y, 
								bolinha3.x, bolinha3.y);
		line3 = new Phaser.Line(bolinha3.x, bolinha3.y, 
								bolinha4.x, bolinha4.y);
		line4 = new Phaser.Line(bolinha4.x, bolinha4.y, 
								bolinha1.x, bolinha1.y);
